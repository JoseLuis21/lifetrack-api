...
type Category interface {
	...
	// pagination
	Fetch(ctx context.Context, token string, limit int64, filter shared.FilterMap) ([]*model.Category, string, error)
	...
	HardRemove(ctx context.Context, id value.UUID) error
}
